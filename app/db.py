...
if __name__ == "__main__":
    ...
    parser.add_argument("-a", "--azione", help="azione da compiere (list_open, list_closed, init, open, close)", type=str, required=True, choices=["list_open", "list_closed", "init", "open", "close"])
